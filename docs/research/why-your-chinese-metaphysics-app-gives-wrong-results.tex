...
What drew the author to this investigation was, in fact,
skepticism.  Upon examining the computational models underlying
several Chinese metaphysical software applications, it became
immediately apparent that many implementations contained obvious
astronomical drift, timezone errors, and calendar miscomputations
by modern standards---errors that their users accepted on faith.
...
two practitioners using the same birth data, the same ephemeris, and the
same sidereal framework can still disagree on mansion placements if
they adopt different ayanamsas.
...
Pisces---a $\sim 24\degree$ discrepancy that sidereal practitioners
consider a fundamental error and tropical practitioners consider
irrelevant.
